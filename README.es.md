...
- **Cabeceras de seguridad estrictas.** Una Content-Security-Policy que solo permite el propio dominio y las cabeceras de refuerzo habituales, verificadas cabecera por cabecera en las pruebas en navegador.
